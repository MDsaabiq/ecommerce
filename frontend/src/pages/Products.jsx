        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
          {filtered.map(product => (
            <div
              ...
              className="bg-gray-800 rounded-xl overflow-hidden cursor-pointer group hover:ring-2 hover:ring-red-500 transition-all duration-200 hover:-translate-y-1 hover:shadow-2xl flex flex-col"
            >
              {/* Fixed-height image */}
              ...
              {/* Card body — fixed layout so all cards are same shape */}
